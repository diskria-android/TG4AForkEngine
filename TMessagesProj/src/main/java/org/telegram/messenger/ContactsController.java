...
public class ContactsController extends BaseController {
    ...
    public void checkAppAccount() {
        ...
        Utilities.globalQueue.postRunnable(() -> {
            ...
            try {
                Account[] accounts = am.getAccountsByType(/* forky comment "org.telegram.messenger" */ /* forky code start */ BuildConfig.APPLICATION_ID /* forky code end */);
            ...
            if (getUserConfig().isClientActivated()) {
                ...
                if (systemAccount == null) {
                    try {
                        systemAccount = new Account("" + getUserConfig().getClientUserId(), /* forky comment "org.telegram.messenger" */ /* forky code start */ BuildConfig.APPLICATION_ID /* forky code end */);
...
//                });
    ...
    private void applyContactToPhoneBook(ArrayList<ContentProviderOperation> query, TLRPC.User user) {
        ...
        builder.withValue(ContactsContract.Data.MIMETYPE, "vnd.android.cursor.item/vnd.org.telegram.messenger.android.profile" /* forky code start */ .replace("org.telegram.messenger", BuildConfig.APPLICATION_ID) /* forky code end */);
        ...
        builder = ContentProviderOperation.newInsert(ContactsContract.Data.CONTENT_URI);
        builder.withValueBackReference(ContactsContract.Data.RAW_CONTACT_ID, rawContactId);
        builder.withValue(ContactsContract.Data.MIMETYPE, "vnd.android.cursor.item/vnd.org.telegram.messenger.android.call" /* forky code start */ .replace("org.telegram.messenger", BuildConfig.APPLICATION_ID) /* forky code end */);
        builder.withValue(ContactsContract.Data.DATA1, user.id);
        ...
        builder = ContentProviderOperation.newInsert(ContactsContract.Data.CONTENT_URI);
        builder.withValueBackReference(ContactsContract.Data.RAW_CONTACT_ID, rawContactId);
        builder.withValue(ContactsContract.Data.MIMETYPE, "vnd.android.cursor.item/vnd.org.telegram.messenger.android.call.video" /* forky code start */ .replace("org.telegram.messenger", BuildConfig.APPLICATION_ID) /* forky code end */);
        builder.withValue(ContactsContract.Data.DATA1, user.id);
